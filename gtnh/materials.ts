...
export class Recipe {
    readonly ingredients: Array<MaterialVolume>;
    readonly result: Array<MaterialVolume>;
    readonly power: number;
    readonly process: Processes;

    constructor(i: Array<MaterialVolume>, r: Array<MaterialVolume>, power: number, process: Processes) {
        this.ingredients = i;
        this.result = r;
        this.power = power;
...
export const Materials = {
    BC_OIL: new Material("BC_OIL", "BuildCraft oil"),

    SULFURIC_GAS: new Material("SULFURIC_GAS", "Sulfuric gas"),
    SULFURIC_LIGHT_FUEL: new Material("SULFURIC_LIGHT_FUEL", "Sulfuric light fuel"),
    SULFURIC_NAPHTA: new Material("SULFURIC_NAPHTA", "Sulfuric naphta"),
    SULFURIC_HEAVY_FUEL: new Material("SULFURIC_HEAVY_FUEL", "Sulfuric heavy fuel"),

    STEAM: new Material("STEAM", "Steam"),
    HYDROGEN: new Material("HYDROGEN", "Hydrogen"),
    HYDROGEN_SULFIDE: new Material("HYDROGEN_SULFIDE", "Hydrogen sulfide"),
    CARBON_T_P: new Material("CARBON_T_P", "Tiny pile of Carbon Dust"),

    REFINERY_GAS: new Material("REFINERY_GAS", "Refinery gas"),
    NAPHTA: new Material("NAPHTA", "Naphta"),
    LIGHT_FUEL: new Material("LIGHT_FUEL", "Light fuel"),
    HEAVY_FUEL: new Material("HEAVY_FUEL", "Heavy fuel"),

    METHANE_GAS: new Material("METHANE_GAS", "Methane gas"),
    ETHANE: new Material("ETHANE", "Ethane"),
    HELIUM_GAS: new Material("HELIUM_GAS", "Helium gas"),
    BUTANE: new Material("BUTANE", "Buthane"),
    PROPANE: new Material("PROPANE", "Propane"),
    TOLUENE: new Material("TOLUENE", "Toluene"),
    BENZENE: new Material("BENZENE", "Benzene"),
    PHENOL: new Material("PHENOL", "Phenol"),
    BUTADIENE: new Material("BUTADIENE", "Butadiene"),
    BUTENE: new Material("BUTENE", "Butene"),
    PROPENE: new Material("PROPENE", "Propene"),
    ETHYLENE: new Material("ETHYLENE", "Ethylene"),
    OCTANE: new Material("OCTANE", "Octane"),

    // naphta cracking
    NAPHTA_H_MOD: new Material("NAPHTA_H_MOD", "Moderately hydro-cracked naphta"),
    NAPHTA_H_LIG: new Material("NAPHTA_H_LIG", "Lightly hydro-cracked naphta"),
    NAPHTA_H_SEV: new Material("NAPHTA_H_SEV", "Severely hydro-cracked naphta"),
    NAPHTA_S_LIG: new Material("NAPHTA_S_LIG", "Lightly steam-cracked naphta"),
    NAPHTA_S_MOD: new Material("NAPHTA_S_MOD", "Moderately steam-cracked naphta"),
    NAPHTA_S_SEV: new Material("NAPHTA_S_SEV", "Severely steam-cracked naphta"),
    // light fuel cracking
    LIGHT_FUEL_H_MOD: new Material("LIGHT_FUEL_H_MOD", "Moderately hydro-cracked light fuel"),
    LIGHT_FUEL_H_LIG: new Material("LIGHT_FUEL_H_LIG", "Lightly hydro-cracked light fuel"),
    LIGHT_FUEL_H_SEV: new Material("LIGHT_FUEL_H_SEV", "Severely hydro-cracked light fuel"),
    LIGHT_FUEL_S_LIG: new Material("LIGHT_FUEL_S_LIG", "Lightly steam-cracked light fuel"),
    LIGHT_FUEL_S_MOD: new Material("LIGHT_FUEL_S_MOD", "Moderately steam-cracked light fuel"),
    LIGHT_FUEL_S_SEV: new Material("LIGHT_FUEL_S_SEV", "Severely steam-cracked light fuel"),
    // heavy fuel cracking
    HEAVY_FUEL_H_MOD: new Material("HEAVY_FUEL_H_MOD", "Moderately hydro-cracked heavy fuel"),
    HEAVY_FUEL_H_LIG: new Material("HEAVY_FUEL_H_LIG", "Lightly hydro-cracked heavy fuel"),
    HEAVY_FUEL_H_SEV: new Material("HEAVY_FUEL_H_SEV", "Severely hydro-cracked heavy fuel"),
    HEAVY_FUEL_S_LIG: new Material("HEAVY_FUEL_S_LIG", "Lightly steam-cracked heavy fuel"),
    HEAVY_FUEL_S_MOD: new Material("HEAVY_FUEL_S_MOD", "Moderately steam-cracked heavy fuel"),
    HEAVY_FUEL_S_SEV: new Material("HEAVY_FUEL_S_SEV", "Severely steam-cracked heavy fuel"),
